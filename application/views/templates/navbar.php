...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
           ...
           <form href="#" data-placement="bottom" rel="popover-focus" data-offset="300" data-toggle="popover-custom" class="nav-link" data-original-title="" title="">
                <i class="fas fa fa-building"> </i>&nbsp; Administrator Pusat &nbsp;
                <i class="fas fa fa-user"></i>&nbsp;  Administrator
            </form>
